...
@NgModule({
  declarations: APP_DI_CONFIG.lazyLoading ? LazyLoadingComponentList : [],
  imports: [
    //AppRoutingModule,
  ...
  entryComponents: APP_DI_CONFIG.lazyLoading ? LazyLoadingEntryComponentList : [],
  bootstrap: [AppComponent]
})
export class LazyLoadingAppModule {
